    ...
    var O = function (h) {
        ...
        function Fa(a, b) {
            var c = o.defaults.column,
                ...
                c = h.extend({}, o.models.oColumn, c, { nTh: b ? b : P.createElement("th"), sTitle: c.sTitle ? c.sTitle : b ? b.innerHTML : "", aDataSort: c.aDataSort ? c.aDataSort : [e], mData: c.mData ? c.mData : e, idx: e });
            a.aoColumns.push(c);
            c = a.aoPreSearchCols;
        ...
        function tb(a) {
            ...
            for (g = 0; g < c; g++)
                (m = b[g]),
                    ...
                    k.columns.push({ data: i, name: m.sName, searchable: m.bSearchable, orderable: m.bSortable, search: { value: l.sSearch, regex: l.bRegex } }),
                    n("mDataProp_" + g, i),
        ...
        function Jb(a) {
            for (var b, c, e = a.aoColumns, d = T(a), a = a.oLanguage.oAria, f = 0, g = e.length; f < g; f++) {
                ...
                c.bSortable &&
                    (0 < d.length && d[0].col == f ? (i.setAttribute("aria-sort", "asc" == d[0].dir ? "ascending" : "descending"), (c = h[d[0].index + 1] || h[0])) : (c = h[0]), (b += "asc" === c ? a.sSortAscending : a.sSortDescending));
        ...
        function Ua(a, b, c, e) {
            ...
            c && a.oFeatures.bSortMulti
                ? ((c = h.inArray(b, D(d, "0"))), -1 !== c ? ((b = g(d[c], !0)), null === b ? d.splice(c, 1) : ((d[c][1] = f[b]), (d[c]._idx = b))) : (d.push([b, f[0], 0]), (d[d.length - 1]._idx = 0)))
                : d.length && d[0][0] == b
        ...
        o = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) R(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    i = q.oClasses;
                    d.bJQueryUI
                        ? (h.extend(i, o.ext.oJUIClasses, d.oClasses), d.sDom === l.sDom && "lfrtip" === l.sDom && (q.sDom = '<"H"lfr>t<"F"ip>'), q.renderer)
                            ? h.isPlainObject(q.renderer) && !q.renderer.header && (q.renderer.header = "jqueryui")
                            : (q.renderer = "jqueryui")
        ...
        o.defaults = {
            ...
            oLanguage: {
                ...
                sInfo: "Affichage _START_ sur _END_ sur _TOTAL_ Objet",
                sInfoEmpty: "Afficher 0 sur 0 sur 0 Objets",
                sInfoFiltered: "(filtered from _MAX_ total Objets)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
                sLengthMenu: "Afficher _MENU_ Objets",
